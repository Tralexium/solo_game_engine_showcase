...
inline void ShaderComponent::useShader()
{
...
// SETERS //
////////////
void ShaderComponent::setProjection(glm::mat4 proj)
{
	u_projection = proj;
}

void ShaderComponent::setView(CameraComponent* view)
{
	u_view = view;
}

void ShaderComponent::setColor(glm::vec3 color)
{
	u_color = color;
}

void ShaderComponent::setLightColor(glm::vec3 l_color)
{
	u_lightColor = l_color;
}

void ShaderComponent::setLightPos(glm::vec3 p_color)
{
	u_lightPos = p_color;
}
